...
Guess a letter, phrase, or type 'exit' or 'pass':""".format(self.name, self.prizeMoney, category, obsecuredPhrase,
                                                            guessed)
...
class WOFComputerPlayer(WOFPlayer):
    ...
    def getPossibleLetters(self, guessed):
        #
        return [l for l in 'ABCDEFGHIJKLMNOPQRSTUVWXYZ' if
                l not in guessed and (l not in 'AEIOU' or self.prizeMoney >= 250)]
